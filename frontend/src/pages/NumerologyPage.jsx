  ...
  return (
    <div className="min-h-screen bg-background p-4 lg:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground">
              {user?.name} — Born {user?.birth_date}
            </p>
          </div>
          ...
          <Button
            ...
            className="bg-primary/10 text-primary hover:bg-primary/20 rounded-xl hidden sm:flex"
            data-testid="discuss-numerology-btn"
          >
        ...
        {/* Tabs */}
        <div className="flex gap-2 mb-8 overflow-x-auto" data-testid="numerology-tabs">
